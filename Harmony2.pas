...
//## Name......... Harmony
//## Type......... Harmony GUI
//## Desciption... Chiming digital clock with alarms and reminders + ships bells
//## Notes........ New MIDI sub-system - fully rebuilt from ground up - supports Windows 95+ and Wine on Linux
//## Version...... 1.00.3320
//## Date......... 15nov2022
//## Lines........ 5,306
//## Copyright.... (c) 1997-2022 Blaiz Enterprises and www.BlaizEnterprises.com
//##############################################################################
...
const
   def_vsep=10;
//high resolution image of sharp edged bell with a background color of "red(255,0,0)" and foreground color of "black(0,0,0)" - 07mar2022
...
//xxxxxxxxxxxxxxxxxxxxxxxxxxxxx//sssssssssssssssssssssssssssssssssss
   ...
   private
    ...
    imustquieten,iinsidescreen,isettingssynclock,isettingsshowing,imaxonstart,ibackmix,iswapcolors,ibuildingcontrol,iloaded:boolean;
    iscrollref64,iignoreclick64,ilaststopactive64,iflashref,iinfotimer,itimer100,itimer250,itimer500:comp;
    isettingsref:string;
    iscrollref,iscrollref2,isettings_display_firstpos,ishortlabellimit,iautodim,ishadepower,ilastfeather,ifeather,ishadestyle,iautoquieten,ialarmpos,ireminderpos,ilastgstate,iframebrightness,itimeformat,idateformat,imorning,ievening,ibrightness4,ibrightness:longint;
    //.color support
...
//defaults
system_onshowoptionsNEWWIDTH:=680;
...
xloadsettings;
xstarttimer;
if imaxonstart then gui.fullscreen:=true;
...
//## xinitColors ##
procedure tprogram.xinitColors;
var
...
if (psettings<>nil) then
   ...
   psettings.vals2['maxonstart']:=imaxonstart;
...
if (psettings<>nil) then
   ...
   imaxonstart:=psettings.vals2['maxonstart'];
   xsubpaint:=true;
   end;
...
a.b['maxonstart']:=prgsettings.bdef('maxonstart',false);
...
ilabel_evening+#1+
//.other
bnc(iswapcolors)+bnc(ibackmix)+bnc(imaxonstart)+'|'+
...
//   low__fromLGF_drawtext2432TAB2(0,sysfont_data[di],a,dx,dy,sw,sh,dcolor,misarea(s),misarea(s),s,nil,-1,xfc,4,false,false,false,false,false,false,corNone);
   low__fromLGF_drawtext2432TAB2(0,sysfont_data[di],a,dx,dy,sw,sh,dcolor,misarea(s),misarea(s),s,nil,-1,xfc,xfeather,false,false,false,false,false,false,corNone);
